...
var makeTwentyArray = function(){
	...
	while(i < array.length){
		...
		while(sub_array.length < 20){
			sub_array.push(array[i])
			if(sub_array.length === 20){
				twenty_array.push(sub_array);
			}
		x++;
		i++;
		}
...
makeTwentyArray();
// console.log(twenty_array)

var FindLargestProduct = function(){
	//x i the row
	var x = 0;
	// i is the index in the row
	var i = 0;
	var largest_num = 0;
...
console.log(FindLargestProduct());